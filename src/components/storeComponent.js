        ...
        return(
            <React.Fragment>
                <div className = {this.props.orientation === "portrait" ? "col-12" : "col-6" }>
                    <img width="100%" src = {this.state.defaultView === true? this.props.item.images[0]:this.props.item.images[this.state.activeFrame]} />
            ...
            style = {{
                ...
                <div className = "row ">
                    <div className = {this.props.orientation ==="landscape"?"col-12 d-flex justify-content-center":"col-4"}>
                        ...
                        <img className = "store-icons rounded-circle" width = {this.props.orientation==="landscape"?"40%":"100%"}src = {this.props.item.icon}></img>
                    </div> 
